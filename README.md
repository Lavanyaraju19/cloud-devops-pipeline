...
This project showcases an end-to-end CI/CD DevOps pipeline using Node.js, PostgreSQL, Docker, Terraform, AWS (ECS, ECR, RDS), GitHub Actions, and ArgoCD. It automates infrastructure deployment, containerization, monitoring, and scaling — ideal for high-performance production apps. Cloud DevOps Pipeline with AWS, Terraform, Node.js & PostgreSQL
...
This project implements a full DevOps pipeline using:

- 🐳 Docker for containerization
- ⚙️ Terraform for infrastructure provisioning (AWS ECR, ECS, RDS)
- 🚀 GitHub Actions & ArgoCD for CI/CD
- 🧠 Node.js for backend development
- 🛢️ PostgreSQL for data storage
- 📦 Helm for Kubernetes deployments
- 📈 k6 for performance testing and benchmarking

This repository demonstrates scalable, production-grade DevOps best practices.
...
- PostgreSQL RDS provisioning and secured access
- CI/CD pipelines with GitHub Actions
- ArgoCD integration for GitOps-style deployments
- Kubernetes manifests + Helm charts
- Performance load testing using k6
- Monitoring with Prometheus & Grafana (optional setup)
...
| Layer              | Tools Used                                   |
|-------------------|----------------------------------------------|
| Infrastructure     | Terraform, AWS (RDS, ECR, ECS, IAM)          |
